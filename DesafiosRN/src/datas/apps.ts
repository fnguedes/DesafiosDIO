...
import CV1 from '../../assets/Apps/Tela2CV.png'
import CV2 from '../../assets/Apps/Tela1CV.png'

export const DestaqueApps=[
  {
    nome:'Cozinha Virtual',
    corFundo:'#FFF',
    corTexto:'#fff',
    slogan:'Seja hobby ou profissão, sua rotina de culinária e alimentação ganham um novo mundo!',
    logo:CozinhaVirtual,
    imagem1:CV1,
    imagem2:CV2,
    link:'https://github.com/fnguedes/Cozinha-Virtual',
  },
]

import NLW from '../../assets/Apps/NLW.png'
export const Rocketseat=[
  {id:1,titulo:'Evento NLW',imagem:NLW,color:'#00292E',secondColor:'#F48F56',txtColor:'#F48F56', link:'https://github.com/fnguedes/NLW-Mobile',}
]